				...
				<ul class="sidebar-links" id="simple-bar">
					...
					<li class="sidebar-list">
						...
						<ul class="sidebar-submenu" style="display: <?php echo e(request()->routeIs(['purchase.index','purchase.create'])  ? 'block' : 'none;'); ?>;">
		                    <li><a href="<?php echo e(route('purchase.index')); ?>" class="<?php echo e(Route::currentRouteName()=='purchase.index' ? 'active' : ''); ?>">Purchases</a></li>
		                    <li><a href="<?php echo e(route('purchase.create')); ?>" class="<?php echo e(Route::currentRouteName()=='purchase.create' ? 'active' : ''); ?>">Create Purchase</a></li>
		                </ul>
					</li>
                    ...
                    <li class="sidebar-list">
						...
						<ul class="sidebar-submenu" style="display: <?php echo e(request()->routeIs(['sales.index','sales.create']) ? 'block' : 'none;'); ?>;">
		                    <li><a href="<?php echo e(route('sales.index')); ?>" class="<?php echo e(Route::currentRouteName()=='sales.index' ? 'active' : ''); ?>">Sales</a></li>
		                    <li><a href="<?php echo e(route('sales.create')); ?>" class="<?php echo e(Route::currentRouteName()=='sales.create' ? 'active' : ''); ?>">Create Sale</a></li>
		                </ul>
					</li>

                    <li class="sidebar-list">
						<a class="sidebar-link sidebar-title <?php echo e(request()->routeIs(['payment.index','payment.create']) ? 'active' : ''); ?>" href="#">
							<i data-feather="dollar-sign"></i><span>Payments</span>
							<div class="according-menu"><i class="fa fa-angle-<?php echo e(request()->routeIs(['payment.index','payment.create']) ? 'down' : 'right'); ?>"></i></div>
						</a>
						<ul class="sidebar-submenu" style="display: <?php echo e(request()->routeIs(['payment.index','payment.create']) ? 'block' : 'none;'); ?>;">
		                    <li><a href="<?php echo e(route('payment.index')); ?>" class="<?php echo e(Route::currentRouteName()=='payment.index' ? 'active' : ''); ?>">Payments</a></li>
		                    <li><a href="<?php echo e(route('payment.create')); ?>" class="<?php echo e(Route::currentRouteName()=='payment.create' ? 'active' : ''); ?>">Create Payment</a></li>
		                </ul>
					</li>
                    <li class="sidebar-main-title">
						<div>
                    ...
                    <li class="sidebar-list">
						...
						<ul class="sidebar-submenu" style="display: <?php echo e(request()->routeIs(['customer.index','customer.create']) ? 'block' : 'none;'); ?>;">
		                    <li><a href="<?php echo e(route('customer.index')); ?>" class="<?php echo e(Route::currentRouteName()=='customer.index' ? 'active' : ''); ?>">Customers</a></li>
                    ...
                    <li class="sidebar-list">
						<a class="sidebar-link sidebar-title <?php echo e(request()->routeIs(['purchaser.index','purchaser.create']) ? 'active' : ''); ?>" href="#">
							<i data-feather="user-check"></i><span>Purchaser</span>
							<div class="according-menu"><i class="fa fa-angle-<?php echo e(request()->routeIs(['purchaser.index','purchaser.create']) ? 'down' : 'right'); ?>"></i></div>
						</a>
						<ul class="sidebar-submenu" style="display: <?php echo e(request()->routeIs(['purchaser.index','purchaser.create']) ? 'block' : 'none;'); ?>;">
		                    <li><a href="<?php echo e(route('purchaser.index')); ?>" class="<?php echo e(Route::currentRouteName()=='purchaser.index' ? 'active' : ''); ?>">Purchasers</a></li>
		                    <li><a href="<?php echo e(route('purchaser.create')); ?>" class="<?php echo e(Route::currentRouteName()=='purchaser.create' ? 'active' : ''); ?>">Create Purchaser</a></li>
		                </ul>
					</li>
                    <li class="sidebar-list">
						<a class="sidebar-link sidebar-title <?php echo e(request()->routeIs(['items.index','items.create']) ? 'active' : ''); ?>" href="#">
							<i data-feather="user-check"></i><span>Items</span>
							<div class="according-menu"><i class="fa fa-angle-<?php echo e(request()->routeIs(['items.index','items.create']) ? 'down' : 'right'); ?>"></i></div>
						</a>
						<ul class="sidebar-submenu" style="display: <?php echo e(request()->routeIs(['items.index','items.create']) ? 'block' : 'none;'); ?>;">
		                    <li><a href="<?php echo e(route('items.index')); ?>" class="<?php echo e(Route::currentRouteName()=='items.index' ? 'active' : ''); ?>">Items</a></li>
		                    <li><a href="<?php echo e(route('items.create')); ?>" class="<?php echo e(Route::currentRouteName()=='items.create' ? 'active' : ''); ?>">Create Items</a></li>
		                </ul>
					</li>
                    <li class="sidebar-list">
						...
						<ul class="sidebar-submenu" style="display: <?php echo e(request()->routeIs(['supplier.index','supplier.create']) ? 'block' : 'none;'); ?>;">
		                    <li><a href="<?php echo e(route('supplier.index')); ?>" class="<?php echo e(Route::currentRouteName()=='supplier.index' ? 'active' : ''); ?>">Suppliers</a></li>
		                    <li><a href="<?php echo e(route('supplier.create')); ?>" class="<?php echo e(Route::currentRouteName()=='supplier.create' ? 'active' : ''); ?>">Create Supplier</a></li>
		                </ul>
					</li>
                    <li class="sidebar-list">
...
<?php /**PATH C:\laragon\www\Chemi\resources\views/ui/layouts/simple/sidebar.blade.php ENDPATH**/ ?>