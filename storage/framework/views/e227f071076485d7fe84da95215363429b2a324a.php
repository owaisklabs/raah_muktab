        ...
        <form action="#" class="row" method="GET">
            <div class="col-md-2 mb-3">
                ...
                <input class="form-control" name="query[invoice_no]"
                       value="<?php echo e(request()->query('query')['invoice_no'] ?? ''); ?>" type="text" placeholder="First name">
            </div>
            <input type="hidden" id="selected_customer_id"
                   value="<?php echo e(request()->query('query')['customer_id'] ?? ''); ?>">
            <div class="col-md-2 mb-3">
            ...
            <div class="col-md-2 mb-3">
                ...
                <input class="form-control" name="query[from_date]"
                       value="<?php echo e(request()->query('query')['from_date'] ?? ''); ?>" id="validationCustom02" type="date">
            </div>
            <div class="col-md-2 mb-3">
                <label for="validationCustom02">To Date</label>
                <input class="form-control" name="query[to_date]"
                       value="<?php echo e(request()->query('query')['to_date'] ?? ''); ?>" id="validationCustom02" type="date">
            </div>
                    ...
                    <div class="card-body">
                        <div class="media align-items-center">
                            <div class="media-body right-chart-content">
                                ...
                                <h4><?php echo e(number_format($totals['total_amount_sum'],2)); ?></h4>
            ...
            <div class="col-xl-4  chart_data_right box-col-12">
                <div class="card">
                    <div class="card-body">
                        <div class="media align-items-center">
                            <div class="media-body right-chart-content">
                                <h4><?php echo e(number_format($totals['paid_amount_sum'],2)); ?></h4>
            ...
            <div class="col-xl-4  chart_data_right box-col-12">
                <div class="card">
                    <div class="card-body">
                        <div class="media align-items-center">
                            <div class="media-body right-chart-content">
                                <h4><?php echo e(number_format($totals['total_amount_sum']-$totals['paid_amount_sum'],2)); ?></h4>
                    ...
                    <table class="table table-border-vertical " style="background-color: white;">
                        ...
                        <?php $__currentLoopData = $sales; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <tr>
                                ...
                                <td><?php echo e($item->total_items_quantity); ?></td>
                                <td><?php echo e(number_format($item->paid_amount,2)); ?></td>
                                <td><?php echo e(number_format($balance,2)); ?></td>
                                <td><span
                                        class="badge rounded-pill <?php echo e($statusClass); ?>"><?php echo e(ucfirst($item->status)); ?></span>
                                </td>
                                <td class="">
                                    <div class="d-flex  gap-1">
                                        
                                        <a href="<?php echo e(route('sales.show', $item->id)); ?>"
                                           class="btn btn-sm btn-primary p-1">
                                            <i data-feather="eye"></i>
                                        </a>

                                        
                                        <a href="<?php echo e(route('sales.edit', $item->id)); ?>"
                                           class="btn btn-sm btn-primary p-1">
                                        ...
                                        <?php if($item->status != 'paid'): ?>
                                            <button class="btn btn-sm btn-success p-1 payment-received"
                                                    data-sales-id="<?php echo e($item->id); ?>" data-receive-amount="<?php echo e($balance); ?>">
                                                <i data-feather="dollar-sign"></i>
                                            </button>
                                        <?php endif; ?>

                                        
                                        <form action="<?php echo e(route('sales.destroy', $item->id)); ?>" method="POST"
                                              class="m-0 p-0">
                                            <?php echo csrf_field(); ?>
                        ...
                        <tr>
                            ...
                            <th>
                            <?php echo e(number_format($sales->sum('total_amount'), 2)); ?></td>
                            <th>
                            <?php echo e(number_format($sales->sum('paid_amount'), 2)); ?></td>
                            <th>
                            <?php echo e(number_format($sales->sum('total_amount') - $sales->sum('paid_amount'), 2)); ?></td>
                        </tr>
                        </tbody>
                    </table>
                </div>
