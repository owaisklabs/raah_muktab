                    ...
                    <table class="table table-border-vertical " style="background-color: white;">
                        ...
                        <tr>
                            ...
                            <td class="d-flex align-items-center gap-2">
                                ...
                                <a href="<?php echo e(route('customer.edit', $item->id)); ?>" class="btn btn-sm btn-primary p-1 d-flex align-items-center justify-content-center">
...
<?php echo $__env->make('ui.layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\raah_muktab\resources\views/customer/index.blade.php ENDPATH**/ ?>