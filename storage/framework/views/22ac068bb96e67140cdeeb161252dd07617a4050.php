                ...
                <div class="login-card">
                    <div>
                        ...
                        <div><a class="logo" href="<?php echo e(route('dashboard')); ?>"><img class="img-fluid for-light"
                                    src="<?php echo e(asset('assets/images/logo/logo_receipt.png')); ?>" alt="looginpage"><img
                                    class="img-fluid for-dark" src="<?php echo e(asset('assets/images/logo/logo_receipt.png')); ?>"
